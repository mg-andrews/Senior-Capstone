    ...
    while (Serial1.available() > 0) {
      ...
      if (c == '\n') {
        ...
        */
        ...
        // BP STATE UPDATE
        BPrandomized = localData[4].toFloat();
          if (BPrandomized == 1.0f) {
              sys_reference = systole - 5;
              systole = (esp_random() % 11) + sys_reference;

              dia_reference = diastole - 5;
              diastole = (esp_random() % 11) + dia_reference;
          }
